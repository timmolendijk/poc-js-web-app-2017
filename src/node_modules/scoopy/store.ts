...
export default class Store {
  ...
  // TODO(tim): This concept of identification by instantiation order is not
  // safe. It depends on the context and the use case whether this will break or
  // not. Maybe we shouldn't offer this short-cut feature at all and force users
  // to take responsibility for identity themselves.
  private nextId;
  resetNextId() {
    this.nextId = 1;
  }
